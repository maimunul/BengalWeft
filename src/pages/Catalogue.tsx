...
const products: Product[] = [
  { category: "men", title: "Navy Oversized Hoodie", desc: "Heavy cotton sweatshirt fabric, zip-through, oversized fit. Available in S–3XL.", moq: "5000 pcs", fabric: "100% Cotton Fleece, 320 GSM", img: productHoodie },
  { category: "men", title: "Striped Co-Ord Set", desc: "Stand collar short sleeve shirt and matching trousers. Smart casual styling.", moq: "5000 pcs", fabric: "100% Cotton Poplin", img: productStripedCoords },
  { category: "men", title: "Classic Denim Shirt", desc: "Button-down denim shirt in medium wash. Timeless design for everyday wear.", moq: "5000 pcs", fabric: "100% Cotton Denim, 6oz", img: productDenimSet },
  { category: "men", title: "Stylish Trousers", desc: "Modern fit charcoal trousers with tapered cut. Perfect for smart-casual occasions.", moq: "5000 pcs", fabric: "65% Polyester, 33% Viscose, 2% Elastane", img: productStylishTrousers },
  ...
  { category: "men", title: "Regular Pajama", desc: "Classic white regular-fit pajama in micro cotton spandex. Elastic waist with back pocket.", moq: "5000 pcs", fabric: "95% Cotton, 5% Spandex Micro", img: productRegularPajama },
  { category: "men", title: "Special Pleat Pajama", desc: "Special pajama with front pleat detailing. Premium micro cotton spandex fabric.", moq: "5000 pcs", fabric: "95% Cotton, 5% Spandex Micro", img: productSpecialPajama },
  { category: "men", title: "Premium Twill Pajama", desc: "Premium pajama in twill cotton spandex fabric for superior comfort and durability.", moq: "5000 pcs", fabric: "97% Cotton, 3% Spandex Twill", img: productPremiumPajama },
  { category: "women", title: "Satin Pajama Set", desc: "Luxe satin shirt and bottoms with contrasting piping trim. Gift-box ready.", moq: "5000 pcs", fabric: "100% Polyester Satin", img: productSatinPj },
  { category: "women", title: "Knit Loungewear Set", desc: "Summer 2-piece set with short-sleeve top and wide-leg pants. Ultra soft.", moq: "5000 pcs", fabric: "95% Viscose, 5% Elastane", img: productKnitLounge },
  { category: "women", title: "Crew Neck T-Shirt Pack", desc: "Women's slim fit basics in 3 versatile colors. Soft hand-feel fabric.", moq: "5000 pcs", fabric: "100% Supima Cotton, 160 GSM", img: productWomenTshirts },
  { category: "women", title: "Purple Pajama Set", desc: "Purple women's pajama set with short-sleeved button-down top and full-length pants.", moq: "5000 pcs", fabric: "100% Cotton Poplin", img: productPurplePj },
  { category: "women", title: "High-Neck Knit Top", desc: "Solid color tight-fitting knit top. Ribbed texture, assorted colors.", moq: "5000 pcs", fabric: "95% Cotton, 5% Spandex Rib", img: productKnitTops },
  { category: "women", title: "Cat Sweatshirt Pajama Set", desc: "Cozy cat-print long-sleeve sweatshirt paired with comfortable pajama bottoms.", moq: "5000 pcs", fabric: "100% Cotton French Terry, 280 GSM", img: productCatPajamaSet },
  { category: "women", title: "Boot-Cut Pants", desc: "Elegant high-waist navy boot-cut pants with flared silhouette for a polished look.", moq: "5000 pcs", fabric: "72% Polyester, 25% Viscose, 3% Elastane", img: productBootcutPants },
  { category: "kids", title: "Kids Playwear Set", desc: "Durable and comfortable everyday set with fun prints. Ages 2–10.", moq: "5000 pcs", fabric: "100% Cotton Jersey, 180 GSM", img: productKidsPlaywear },
  { category: "kids", title: "Girls' Summer Dress", desc: "Lightweight floral dress with flutter sleeves. Perfect for warm weather.", moq: "5000 pcs", fabric: "100% Cotton Voile", img: productGirlsDress },
  { category: "innerwear", title: "Women's Underwear Set", desc: "Elegant cotton underwear in soft pastel colors for all-day comfort. Tagless design.", moq: "5000 pcs", fabric: "95% Combed Cotton, 5% Spandex", img: productWomensUnderwear },
  { category: "innerwear", title: "Women's Inner Full Set", desc: "Matching camisole top and shorts set in soft cotton. Everyday essential.", moq: "5000 pcs", fabric: "100% Cotton Jersey, 180 GSM", img: productWomensInnerSet },
  { category: "innerwear", title: "Sports Performance Briefs", desc: "Moisture-wicking active innerwear with anti-chafe flatlock seams.", moq: "5000 pcs", fabric: "90% Nylon, 10% Spandex", img: productSportsInnerwear },
  { category: "innerwear", title: "Thermal Base Layer Set", desc: "Warm base layer top and bottom for cold weather. Lightweight insulation.", moq: "5000 pcs", fabric: "60% Merino Wool, 40% Polyester", img: productThermal },
  { category: "innerwear", title: "Jockstrap Collection", desc: "Premium jockstrap underwear in vibrant coral, mint, and pink with branded waistband.", moq: "5000 pcs", fabric: "85% Nylon, 15% Spandex", img: productJockstrap },
  { category: "innerwear", title: "Jockstrap Detail View", desc: "Athletic jockstrap with branded waistband, available in multiple colorways.", moq: "5000 pcs", fabric: "85% Nylon, 15% Spandex", img: productJockstrapDetail },
  { category: "innerwear", title: "Thong Collection", desc: "Fashionable thong underwear set in tie-dye and printed designs.", moq: "5000 pcs", fabric: "92% Cotton, 8% Spandex", img: productThong },
  { category: "activewear", title: "Mesh Performance T-Shirt", desc: "Sporty mesh panel t-shirt with embroidery details. Available in off-white and black.", moq: "5000 pcs", fabric: "100% Polyester Mesh, 150 GSM", img: productFilaTshirt },
  { category: "activewear", title: "Swimming Set", desc: "Modern vibrant swimwear set with stylish design, perfect for beach and pool.", moq: "5000 pcs", fabric: "80% Nylon, 20% Spandex", img: productSwimmingSet },
];
